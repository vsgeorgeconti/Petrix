...
namespace Petrix.Infrastructure.Persistence.Repositories
{
    public class CustomerRepository : ICustomerRepository
    {
        ...
        public async Task<Customer?> GetByDocumentNumberAsync(string documentNumber) => await _context.Customers.AsNoTracking().Where(x => x.DocumentNumber == documentNumber).FirstOrDefaultAsync();
